...
func insertUser() {
	...
	u.Email = "huibaoyongze@gmail.com"
	u.Description = "I'm admin"
	u.User_type = 1
	u.State = 1
	o = orm.NewOrm()
	o.Insert(u)
...
func insertPriModule() {
	fmt.Println("insert insertPriModule ...")
	p := new(Privilege)
	p.Name = "Admin"
	p.Remark = "I'm a Privilege role"
	p.Status = 2
	p.Title = "Privilege role"
	o.Insert(p)
	fmt.Println("insert insertPriModule end")
}
